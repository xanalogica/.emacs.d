...
1. write Christmas party invitation
2. text Aimee re $200 owed
3. fix Category of 'Ann' that bleeds over
4. fix [qQ]uotes.org
5. fix Finance.org
6. sync and merge in Inbox.org
...
F Captured Info Needing Filing
 ...
 - MENU IS "
 - collecting :REFILING: but confuses "filing destinations" with "things needing refiling"
