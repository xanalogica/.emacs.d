...
#+BEGIN_SRC emacs-lisp
  (setq my/links-needing-refiling ;; presention definition using org-super-agenda
    '(
  ...
  (setq org-agenda-custom-commands
    '(
       ...
       ("L" "Captured Links Needing Refiling" tags  ;; (key[1] desc[2] type[3]
         "+LINK+REFILING"  ;; (org-super-agenda-mode)  ;; match[4]
         ( ; [5] list of settings local to this custom agenda view
           (org-super-agenda-groups my/links-needing-refiling)
         )
     )
  )
#+END_SRC
