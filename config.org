...
#+BEGIN_SRC emacs-lisp
  ...
  (setq notmuch-saved-searches '(
    (:name "Directs"   ; HIGH-PRIORITY EMAILS BECAUSE WHO IS SENDING
       ...
       :key   "D"
       :count-query "tag:inbox and tag:directSam"
       :sort-order newest-first
       :search-type 'tree)
    (:name "Flagged"   ; HIGH-PRIORITY EMAILS THAT I HAVE INDICATED
    ...
    (:name "drafts"    ; should be kept very minimal
       ...
       :search-type nil)
    (:name "ZeInbox"   ; things I need to take care of
       :query "tag:inbox and tag:zeomega"
       :key   "ZI"
       :count-query "tag:inbox and tag:zeomega and tag:unread"
       :sort-order newest-first
       :search-type 'tree)
    (:name "XaInBox"   ; things I need to take care of
