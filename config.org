...
;;;           (org-agenda-add-entry-text-maxlines 5)  ;; experimental
       ...
       ("F" "Captured Info Needing Filing" tags  ;; key[1] desc[2] type[3]
         "+REFILING"  ;; entry match-expression[4]
         ( ;; [5] list of settings local to this custom agenda view
           (org-agenda-overriding-header "Captured Info Needing Filing")
           (org-super-agenda-groups groups/items-needing-refiling)

           (org-agenda-remove-tags t)
         )
         ("/tmp/CapturedNewInfo.pdf")  ;; file(s)-to-export[6]
       )
...
#+BEGIN_SRC emacs-lisp
  (setq groups/links-needing-refiling  ;; presentation definition using org-super-agenda
    '(
       (:name "Captured Info Needing Filing"
