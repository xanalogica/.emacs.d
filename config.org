...
#+BEGIN_SRC emacs-lisp
  (setq org-link-abbrev-alist
      '(
#+LINK:		karmic https://karmic.zeomega.com/browse/%s
#+LINK:		story https://karmic.zeomega.com/browse/%s
#+LINK:		task https://karmic.zeomega.com/browse/%s
#+LINK:		subtask https://karmic.zeomega.com/browse/%s
#+LINK:		epic https://karmic.zeomega.com/browse/%s
#+LINK:		zeconnect https://zeconnect.zeomega.com/display/%u
#+LINK:		github https://github.com/%s
#+LINK:		git https://git.zeomega.com/%s
...
#+BEGIN_SRC text
  ...
  (file+olp "~/Dropbox/Documents/Org-Mode/ZeOmega.org"
...
#+BEGIN_SRC text
  ...
  (file+headline "~/Dropbox/Documents/Org-Mode/ZeOmega.org"
...
#+BEGIN_SRC text
  ...
  (file+headline "~/Dropbox/Documents/Org-Mode/index.org"
                 "Unclassified Bookmarks"
  )
...
#+BEGIN_SRC emacs-lisp	:results silent
  (setq org-refile-targets
    '( ; file(s) to look inside of                           ; destination headings
      ("~/Dropbox/Documents/Org-Mode/quotes.org"   :regexp . "Disorganized Quotations")
      ("~/Dropbox/Documents/Org-Mode/index.org"    :regexp . "Project: Riverhood")  ;; NEEDS A CAPTURE TEMPLATE
      ("~/Dropbox/Documents/Org-Mode/ZeOmega.org"  :regexp . "Hadoop: Financial Dashboard")
      ("~/Dropbox/Documents/Org-Mode/ZeOmega.org"  :regexp . "Hadoop: Sentinel Engine")

      ("~/Dropbox/Documents/Org-Mode/Travel.org"   :regexp . nil) ;; all headings in Travel.org
      ;; Travel.org		AustinTrip.org-> Travel.org

      ;; file:Church.org *Church:%20River%20of%20Glory
      ;; Church-Riverhood.org file:Church.org *Project:%20Riverhood][Church.org: Riverhood
      ;; file:HomeDecor.org
      ;; Blog-logfile.org
      ;; Blog-content.org | Blog-test2.org | Blog-test.org (receives my philosophy, my memories)
      ;; Finance.org
      ;;   - credit scores
      ;; Health.org of the Mind, of the Body, of the Spirit
      ;;   - latest bloodwork
      ;; quotes
      ;; sexy songs
      ;; stashed links

      ;; unclassified personal tasks
      ;;   - define a recurring weekly task to sort them
      ;; unclassified ZeOmega tasks
      ;;   - define a recurring weekly task to sort them
    )
  )

  (setq org-completion-use-ido nil)
  (setq org-refile-use-outline-path t)  ; Show full filepaths for refiling
