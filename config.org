...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-log-refile (quote time))  ;;   and when I refile a headline
...
When I mark a task DONE I want to capture a timestamp of when I completed it.
I keep all my timestamps in increments of 15-minutes, for easier mental
calculations.
