...
#+BEGIN_SRC emacs-lisp :results silent :exports code
  ...
  (setq org-agenda-custom-commands
    '(  ; (key desc type match settings files)
       ("J" "Agenda for Current Period" agenda
         (org-super-agenda-mode)

         ( ; list of local settings, only one in this case
           (org-agenda-span 7)
...
;;; (org-agenda-entry-types '(:timestamp :sexp))
           ...
           (org-super-agenda-groups
             '(
                (:name "Health"  ; Optionally specify section name
                 :time-grid t    ; Items that appear on the time grid
                 :tag "HEALTH"   ; Items that have this TAG keyword
                )

                (:name "Finance" ; Optionally specify section name
                 :tag "FINANCE"  ; Items that have this TAG keyword
                )

                (:name "ZeOmega" ; Optionally specify section name
                 :tag "ZEOMEGA"  ; Items that have this TAG keyword
                )

                (:name "Chore"   ; Optionally specify section name
                 :tag "CHORE"    ; Items that have this TAG keyword
                )

                (:name "Event"   ; Optionally specify section name
                 :tag "EVENT"    ; Items that have this TAG keyword
                )

                (:name "Travel"  ; Optionally specify section name
                 :tag "TRAVEL"   ; Items that have this TAG keyword
                )

                (:name "People"  ; Optionally specify section name
                 :tag "PEOPLE"   ; Items that have this TAG keyword
                )

                (:name "Writing" ; Optionally specify section name
                 :tag "WRITING"  ; Items that have this TAG keyword
                )

                (:name "Study"   ; Optionally specify section name
                 :tag "STUDY"    ; Items that have this TAG keyword
                )
