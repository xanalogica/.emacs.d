...
#+BEGIN_SRC emacs-lisp :results code :var keyseq="bp" :session plugh
(defun health-bloodpressure-m (keyseq) "blah"
...
#+HEADERS: :var health-bloodpressure-m=(health-bloodpressure-measurements "bp")
#+BEGIN_SRC emacs-lisp :results code
  (setq org-capture-templates
    (list
       (health-bloodpressure-m "bp")
