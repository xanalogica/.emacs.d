...
In Popup List of Agenda-Views:
  Captured Links Needing Refiling: +LINK+REFILING
  try: (org-agenda-menu-show-matched nil)
  try: (org-agenda-menu-two-columns t)
...
try: (org-agenda-compact-blocks t)
try: (org-agenda-add-entry-text-descriptive-links nil)
...
(org-agenda-time-of-day-to-ampm t)

try: C-u l    to show ALL log entries in agenda log mode

 '(org-agenda-format-date (quote org-agenda-format-date-aligned-jrr))
 '(org-agenda-prefix-format "  %-17:c%?-20t% s")
 '(org-agenda-span 60)
