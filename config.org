...
#+BEGIN_SRC emacs-lisp
  (defun jeff/insert-initiatives ()
    ...
    (save-mark-and-excursion
      ...
      ; (setq patt (jeff/get-link-desc)) ;; capture org-link desc of headline
      ; (setq patt (format "%S" patt))
      ; (setq patt "RD-46")
      ; (setq patt (make-link-to-here)) ;; capture an org-link to the headline
    )
  ...
  (defun jeff/get-link-desc ()
    "Obtain the description of headline to which we are positioned."
...
;;;    (call-interactively 'org-store-link)
    ...
    (setq retval link)
    (setq retval desc)
    (setq retval (org-make-link-string link desc))
