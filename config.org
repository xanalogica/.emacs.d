...
~specific topics~ are:
  ...
  - l   general link to remember  (tagged, not located)
...
Things that should be in one place are:
  ...
  - meeting notes (they result in documented understandings, action items, questions)
    - zd  DevOps
    - zs  Sentinel
    - ABI??
    - zh  ETL/Java
...
I want to produce an agenda view for meeting with Sam, where I show my
  questions, my action items and collect notes on our discussion.
  ...
  za  Action Item to Address
  j   a dated journale ntry
  t   a TODO item to be classified
  r   research to undertake
  n   unplanned meeting or brainstorming
  b   blood pressure measurement
  q   quote to remember
  c   someone to contact
  m   an unplanned meeting
  p   a sudden phone call
  b   a book to read          tag, not place so that books on different topics can be under different headlines
  v   a video to watch
  m   music idea
  w   website to visit
  e   an event to attend
