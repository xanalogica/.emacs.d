...
#+BEGIN_SRC emacs-lisp :var keyseq="c" :results value
  (list
...
#+BEGIN_SRC emacs-lisp :var keyseq="b" :results value
  (setq health-bloodpressure-measurements (defun health-bloodpressure-measurements (keyseq) "blah"
    (list
...
#+END_SRC
;;;  (defun health-bloodpressure-measurements (keyseq) "blah"
...
#+BEGIN_SRC emacs-lisp :results code :noweb yes :var bp=health-bloodpressure-measurements
