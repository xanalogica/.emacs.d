...
primarily for making key definition more clear and concise.

#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path
      "~/.emacs.d/lisp/general.el/general.el"
  )
  (require 'general)
;;;  (use-package general
;;;    :ensure nil  ;; this package is essential for this configuration to work
;;;    :load-path "~/.emacs.d/lisp/general.el/" ;; use my Git checkout
;;;  )
#+END_SRC
