...
;;;  (require 'notmuch-labeler)   ;; improve presentation of Notmuch labels
  ...
  (setq notmuch-saved-searches '(
    (:name "Directs"
       :query "tag:inbox and to:jrush@zeomega.com and (from:linuxkiddo@gmail.com or from:sam@zeomega.com)"
       :key   "D"
       :count-query "tag:inbox to:jrush@zeomega.com and (from:linuxkiddo@gmail.com or from:sam@zeomega.com) and tag:unread"
