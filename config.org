...
- [ ]  "B" :: <<capture--health-bloodpressure-measurements>>
- [ ]  "F" :: <<capture--finance-creditscore-measurements>>
- [ ]  "q" :: <<capture--cool-quote>>
- [ ]  "z" :: "ZeOmega Capture Templates"
- [ ]  "zf" :: <<capture--hadoop-financial>>
- [ ]  "zs" :: <<capture--hadoop-sentinelengine>>
- [ ]  "zb" :: <<capture--bookmarks-zeomega>>
