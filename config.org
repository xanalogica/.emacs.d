...
This is an ongoing copy of my Emacs configuration, annotated with explanations.
   ...
   '(mode-line (
      (
        (
          (class color)
          (min-colors 88)
        ) (:background "deep sky blue" :foreground "black" :box (:line-width -1 :style released-button) :height 1.3))
        )
      )
