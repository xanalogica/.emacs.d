...
** Install the 'use-package' module to more efficiently organize packages
...
#+RESULTS:
| #s(package-desc diminish (0 45) Diminished modes are minor modes with no modeline display nil single melpa-stable nil ((:commit . 0211de96b7cfba9c9dc8d2d392dbd4ccdb22bc65) (:keywords extensions diminish minor codeprose) (:authors (Will Mengarini . seldon@eskimo.com)) (:maintainer Martin Yrjölä . martin.yrjola@gmail.com) (:url . https://github.com/myrjola/diminish.el)) nil) | #s(package-desc bind-key (2 3) A simple way to manage personal keybindings nil single melpa-stable nil ((:commit . cd58b268a8a025451c11c3cb1ba18d4f27f245da) (:keywords keys keybinding config dotemacs) (:authors (John Wiegley . jwiegley@gmail.com)) (:maintainer John Wiegley . jwiegley@gmail.com) (:url . https://github.com/jwiegley/use-package)) nil) | #s(package-desc use-package (2 3) A use-package declaration for simplifying your .emacs ((bind-key (1 0)) (diminish (0 44))) single melpa-stable nil ((:commit . cd58b268a8a025451c11c3cb1ba18d4f27f245da) (:keywords dotemacs startup speed config package) (:authors (John Wiegley . jwiegley@gmail.com)) (:maintainer John Wiegley . jwiegley@gmail.com) (:url . https://github.com/jwiegley/use-package)) nil) |
...
#+RESULTS:
#+BEGIN_SRC emacs-lisp
(("l" "Captured Links" entry
  (file+headline "~/Dropbox/Documents/index.org" "Captured Links")
  "*** %(org-cliplink-capture) %^G\n:PROPERTIES:\n:CREATED: %U\n:END:\nURL:%x\n%?" :prepend nil :kill-buffer t :empty-lines-before 1 :empty-lines-after 0)
 ("n" "Captured Notes" entry
  (file+headline "~/Dropbox/Documents/index.org" "Captured Notes")
  "*** %^{Note Title} %^G\n:PROPERTIES:\n:CREATED: %U\n:END:\n%i\n%?" :prepend nil :kill-buffer t :empty-lines-before 0 :empty-lines-after 1)
 ("t" "Captured Tasks" entry
  (file+headline "~/Dropbox/Documents/index.org" "Captured Tasks")
  "*** %^{Task Title} %^G\n:PROPERTIES:\n:CREATED: %U\n:END:\n%i\n%?" :prepend nil :kill-buffer t :empty-lines-before 0 :empty-lines-after 1)
 ("B" "a Bloodpressure measurement" table-line
  (file+headline "~/Dropbox/Documents/Health.org" "Jeff's Blood Pressure History")
  "| %u | %^{High} | %^{Low} | %^{Pulse} | %^{Comment} |" :prepend t :unnarrowed t :kill-buffer t)
 ("F" "a new FICO Monthly Score" table-line
  (file+headline "~/Dropbox/Documents/Finance.org" "Jeff's FICO Credit Score History")
  "| %^{Date}u | %^{Score} | | |" :prepend t :unnarrowed t :kill-buffer t)
 ("q" "a Catchy Quote" entry
  (file+headline "~/Dropbox/Documents/quotes.org" "Disorganized Quotations")
...
I use This folding minor mode in myorg-agenda views to help make sense of
complex sets of information.

#+BEGIN_SRC emacs-lisp :results silent
  (push "~/.emacs.d/lisp/origami.el" load-path)
  (require 'origami)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :results silent :exports code
  ...
  (setq org-agenda-custom-commands
    '(  ; (key desc type match settings files)
       ...
       ("B" "Backlog of Unscheduled Tasks" todo
         (org-super-agenda-mode)
       ...
       ("R" "Recurring/Habits" todo
         (org-super-agenda-mode)

         ( ; list of local settings
           (org-super-agenda-groups
             '(
                (:discard (:not (:scheduled t :deadline t)))
