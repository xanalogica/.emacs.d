...
HOW is 'org-agenda-type' getting set to nil?

(setq org-agenda-scheduled-leaders '("" ""))
??? org-agenda-prefix-format controls whether to apply the org-agenda-scheduled-leaders ???
...
;;  (setq org-agenda-scheduled-leaders
;;    '("Scheduled: " ""))
;;  (setq org-agenda-show-inherited-tags
;;    nil)
