...
The [[https://github.com/jwiegley/use-package][use-package]]^github ELisp macro allows one to isolate package configuration
in your Emacs configuration files in a way that is both performance-oriented
and tidy.

[[#package-installation][GitHub - jwiegley/use-package: A use-package declaration for simplifying your...]
