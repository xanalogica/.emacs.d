...
#+BEGIN_SRC emacs-lisp :results value :var name="finance-creditscore-measurements"
  (defun name (keyseq)
   "blah"
...
#+NAME: health-bloodpressure-measurementsZZZ
#+BEGIN_SRC emacs-lisp :results value
  (defun health-bloodpressure-measurementsZZZ (keyseq)
   "blah"
