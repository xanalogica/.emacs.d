...
[[http://pages.sachachua.com/.emacs.d/Sacha.html#org2a3d302][Sacha Chua's Emacs configuration]] (really neat display of her .emacs file)
...
#+BEGIN_SRC emacs-lisp	:results silent
  (setq org-refile-targets
    '( ; file(s) to look inside of                           ; destination headings
      ("~/Dropbox/Documents/Quotes.org"   (:maxlevel . 1) (:tag . "REFILING"))
      ("~/Dropbox/Documents/Personal.org" (:maxlevel . 1) (:tag . "REFILING"))
