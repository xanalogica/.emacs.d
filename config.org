...
;;; add close date to entry
;;; add category/file of where entry is
;;; how to add time brackets
;;; add archive files to search space
...
(org-columns-default-format "%CLOSED(CLOSE DATE) %CATEGORY %TIMESTAMP %3PRIORITY %25ITEM")

;; CATEGORY TIMESTAMP PRIORITY ITEM
