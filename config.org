...
* About Packages, Casks, Pallets and Repositories (oh my!)
- want to auto pull a package if I reference it in here
- want to keep all setup related to a package near where that package is imported
- but want to group the various packages why the type of thing they do (UI, ...)
...
| diminish                | Initialized | 2019-12-03 Tue 20:17 | 0.00 |
| bind-key                | Configured  | 2019-12-03 Tue 20:17 | 0.00 |
| general                 | Configured  | 2019-12-03 Tue 20:17 | 0.02 |
| pallet                  | Configured  | 2019-12-03 Tue 20:17 | 0.21 |
| hydra                   | Configured  | 2019-12-03 Tue 20:17 | 0.01 |
| epa-file                | Configured  | 2019-12-03 Tue 20:17 | 0.00 |
| org-crypt               | Configured  | 2019-12-03 Tue 20:17 | 0.00 |
| ox-jira                 | Configured  | 2019-12-03 Tue 20:17 | 0.12 |
| ob-browser              | Configured  | 2019-12-03 Tue 20:17 | 0.00 |
| yasnippet               | Configured  | 2019-12-03 Tue 20:17 | 0.05 |
| orgnav                  | Initialized | 2019-12-03 Tue 20:17 | 0.00 |
| yafolding               | Configured  | 2019-12-03 Tue 20:17 | 0.00 |
| highlight-indent-guides | Configured  | 2019-12-03 Tue 20:17 | 0.00 |
| rst                     | Configured  | 2019-12-03 Tue 20:17 | 0.02 |
| yaml-mode               | Initialized | 2019-12-03 Tue 20:17 | 0.00 |
| python                  | Initialized | 2019-12-03 Tue 20:17 | 0.00 |
| org-cliplink            | Configured  | 2019-12-03 Tue 20:17 | 0.07 |
| org-protocol            | Configured  | 2019-12-03 Tue 20:17 | 0.00 |
| org-collector           | Configured  | 2019-12-03 Tue 20:17 | 0.01 |
| org-super-agenda        | Declared    | 2019-12-03 Tue 20:17 | 0.00 |
| origami                 | Initialized | 2019-12-03 Tue 20:17 | 0.00 |
| org-mime                | Initialized | 2019-12-03 Tue 20:17 | 0.00 |
| org-notmuch             | Configured  | 2019-12-03 Tue 20:17 | 0.01 |
| atomic-chrome           | Configured  | 2019-12-03 Tue 20:17 | 1.12 |
...
#+BEGIN_SRC emacs-lisp :no-expand

  ;; Academic Paper version 6 format
;;  (add-to-list 'org-latex-classes
...
#+BEGIN_SRC emacs-lisp
  (use-package ox-jira
    :load-path "~/.emacs.d/lisp/ox-jira.el/" ;; use my Git checkout
  )
#+END_SRC
...
*** Exporting HTML/CSS into a Graphic

https://github.com/krisajenkins/ob-browser

#+BEGIN_SRC emacs-lisp
  (use-package ob-browser
    :load-path "~/.emacs.d/lisp/ob-browser/" ;; use my Git checkout
  )
#+END_SRC
...
#+BEGIN_SRC browser :out /tmp/demo.png
  <!DOCTYPE html>
  <html>
      <head>
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;; hl-line-face
  (set-face-attribute 'hl-line nil :inherit nil :background "darkred")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package grandshell-theme
    :ensure t  ;; this package IS essential to my basic Emacs look
  )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package highlight-indent-guides
    :load-path "~/.emacs.d/lisp/highlight-indent-guides/" ;; use my Git checkout
    :config
...
;;;      (define-key yaml-mode-map "\t" 'yafolding-toggle-element)
;;;      (define-key yaml-mode-map "\C-c>" 'indent-tools-hydra/body)
...
rush@pop-os:~/Z/jiva/jiva-platform/analytics-ruleengine$ locate beancount.el
/usr/share/emacs/site-lisp/elpa/beancount-2.2.3.0/beancount.el
/usr/share/emacs/site-lisp/elpa/beancount-2.2.3.0/beancount.elc
/usr/share/emacs/site-lisp/elpa-src/beancount-2.2.3.0/beancount.el

#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path "/usr/share/emacs/site-lisp/elpa/beancount-2.2.3.0/")
  (require 'beancount)
  (add-to-list 'auto-mode-alist '("\\.beancount\\'" . beancount-mode))
...
;;    :interpreter
;;      ("beancount" . beancount-mode)
;;    :load-path "/usr/share/emacs/site-lisp/elpa/beancount-2.2.3.0/"
;;  )
  ...
  (setq org-tag-alist
    '(
      ...
      (:startgrouptag)("PEOPLE")
        (:grouptags)("{PPL_.+}")("PEOPLE")
      (:endgrouptag)

      (:startgrouptag)("CLIENTS")
        (:grouptags)("{CL_.+}")
      (:endgrouptag)

;;;      (:startgrouptag)("TO_ACT")
;;;        (:grouptags)("{TO_.+}")
;;;      (:endgrouptag)

      (:startgrouptag)("EVENTS")
        (:grouptags)("{EVT_.+}")
      (:endgrouptag)

      (:startgrouptag)("HEALTH")
        (:grouptags)("FITNESS")("MEDICAL")("DIET")
      (:endgrouptag)

      (:startgrouptag)("FINANCE")
        (:grouptags)("TAX")("INVESTMENT")("INCOME")
      (:endgrouptag)

      (:startgrouptag)("PLACE")
        (:grouptags)("DINE")("BUY")("PLACE")
      (:endgrouptag)

      (:startgrouptag)("PROBLEM")
        (:grouptags)("ISSUE")
      (:endgrouptag)

      (:startgrouptag)("TECHNOLOGY")
        (:grouptags)("KUBERNETES")
      (:endgrouptag)

      (:startgrouptag)("KUBERNETES")
        (:grouptags)("HELMCHART")
      (:endgrouptag)
...
- EVENT	:: a specific dated event, of a timeline
...
- MEETINGS      :: collection subtree for all meetings of a kind
...
#+BEGIN_SRC text
  "a Blog Post" entry
  (file+headline "~/Dropbox/Documents/Blog/content.org"
                 "My Blog Posts")
...
***** TODO A ZeOmega General Meeting
#+NAME: capture--zeomega-meeting
#+BEGIN_SRC text
  "ZeOmega Meeting" entry
...
#+NAME: capture--about-generic
#+BEGIN_SRC text
  "Captured Annotation" entry
  (file+headline "~/Dropbox/Documents/index.org"
                 "Index Unclassified Entries"
  )
...
;; People: Pavan
      ...
      ("~/Dropbox/Documents/techdocs/about-cicd.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/rulesengine.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/clicbank.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/codequality.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/corefunctions.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/deployment.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/datalifecycle.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/operations.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/architecture.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/clustercomputing-hadoop.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/officetools.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/multicloud.org" :tag . "REFILING")
      ("~/Dropbox/Documents/techdocs/aiml.org" :tag . "REFILING")
    )
  )
...
**** Enabling Display of Entities Inline
...
#+BEGIN_SRC emacs-lisp
  (org-babel-lob-ingest "~/.emacs.d/library.org")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package restclient
    :load-path "~/.emacs.d/lisp/restclient/" ;; use my Git checkout
    :ensure nil    ;; do NOT install from ELPA but look for it already on my machine
    :demand t      ;; force loading to occur immediately, even if conditions exist to defer
  )
#+END_SRC

#+BEGIN_SRC emacs-lisp
  (use-package restclient
    :load-path "~/.emacs.d/lisp/ob-restclient/" ;; use my Git checkout
    :ensure nil    ;; do NOT install from ELPA but look for it already on my machine
    :demand t      ;; force loading to occur immediately, even if conditions exist to defer
  )
#+END_SRC
  ...
  (defun my-org-confirm-babel-evaluate (lang body)
    (not
      (or
        ...
        (string= lang "elisp")          ; don't ask for emacs-lisp
...
*** Using the SciMax org-babel Python for async execution of Python source blocks
...
;;  (setq org-babel-async-python-show-line-numbers t)
...
Error (use-package): Failed to install
  scimax-org-babel-python:
    Package ‘scimax-org-babel-python-’ is unavailable
...
#+BEGIN_SRC emacs-lisp :exports code
  ...
  (setq org-agenda-start-on-weekday
    nil)
  (setq org-agenda-show-future-repeats
    nil)
  (setq org-agenda-prefer-last-repeat
    nil)
...
****** About TODO Dependencies

1. When TODO dependencies are *enforced* with the
   ~org-enforce-todo-dependencies~ setting, then a parent TODO cannot be
   marked *DONE* if any of its children TODO entries are not marked *DONE*.

   This means work must be completed bottom-to-top in the overall tree of
   tasks.

2. If a parent has an :ORDERED: property, children TODO entries cannot be
   marked *DONE* unless all of the parent's prior siblings have benned marked
   *DONE*.

   This means work must be completed from left-to-right in the overall tree of
   tasks.

3. If a parent is blocked from being marked *DONE* due to ordered siblings of
   its own, the parent's children will also be blocked.
...
#+BEGIN_SRC emacs-lisp :exports code :noweb yes
  (setq org-agenda-custom-commands
    '(
       ...
       <<define-agenda-pC-Covid19Timeline>>
       <<define-agenda-pD-PersonalDirections>>
       <<define-agenda-pI-PersonalInitiatives>>
       <<define-agenda-pT-PersonalTimeline>>
       <<define-agenda-pd-PersonalDocuments>>
       ...
       <<define-agenda-zM-ZeOmegaMeetings>>
       <<define-agenda-zT-ZeOmegaTimeline>>
       <<define-agenda-zd-TechDocuments>>
...
******* Now Initialize the org-super-agenda package
...
Its value is
("~/.emacs.d/lisp/origami/" "~/.emacs.d/lisp/org-super-agenda/" "~/.emacs.d/lisp/org-collector/" "~/.emacs.d/lisp/org-cliplink" "~/.emacs.d/lisp/highlight-indent-guides/" "~/.emacs.d/lisp/indent-tools" "~/.emacs.d/lisp/orgnav/" "~/.emacs.d/lisp/ob-browser/" "~/.emacs.d/lisp/ox-jira.el/" "~/.emacs.d/lisp/general/" "/home/jrush/.emacs.d/.cask/26.3/elpa/atomic-chrome-2.0.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/beacon-1.3.4" "/home/jrush/.emacs.d/.cask/26.3/elpa/counsel-0.13.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/docker-tramp-0.1" "/home/jrush/.emacs.d/.cask/26.3/elpa/git-annex-1.1" "/home/jrush/.emacs.d/.cask/26.3/elpa/git-auto-commit-mode-4.6.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/gitlab-0.8.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/gitlab-ci-mode-20190824.12.2" "/home/jrush/.emacs.d/.cask/26.3/elpa/grandshell-theme-1.3" "/home/jrush/.emacs.d/.cask/26.3/elpa/ht-2.2" "/home/jrush/.emacs.d/.cask/26.3/elpa/htmlize-1.55" "/home/jrush/.emacs.d/.cask/26.3/elpa/hydra-0.15.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/ledger-mode-4.0.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/lv-0.15.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/magit-todos-1.5.2" "/home/jrush/.emacs.d/.cask/26.3/elpa/hl-todo-3.1.2" "/home/jrush/.emacs.d/.cask/26.3/elpa/org-bullets-0.2.4" "/home/jrush/.emacs.d/.cask/26.3/elpa/org-magit-0.2.2" "/home/jrush/.emacs.d/.cask/26.3/elpa/magit-2.90.1" "/home/jrush/.emacs.d/.cask/26.3/elpa/magit-popup-2.13.2" "/home/jrush/.emacs.d/.cask/26.3/elpa/git-commit-2.90.1" "/home/jrush/.emacs.d/.cask/26.3/elpa/ghub-3.3.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/org-mime-20120112" "/home/jrush/.emacs.d/.cask/26.3/elpa/org-special-block-extras-1" "/home/jrush/.emacs.d/.cask/26.3/elpa/dash-functional-2.17.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/pallet-0.9.2" "/home/jrush/.emacs.d/.cask/26.3/elpa/cask-0.8.4" "/home/jrush/.emacs.d/.cask/26.3/elpa/pcre2el-1.8" "/home/jrush/.emacs.d/.cask/26.3/elpa/pdf-tools-0.90" "/home/jrush/.emacs.d/.cask/26.3/elpa/pip-requirements-0.5" "/home/jrush/.emacs.d/.cask/26.3/elpa/pkg-info-0.6" "/home/jrush/.emacs.d/.cask/26.3/elpa/py-autopep8-2016.1" "/home/jrush/.emacs.d/.cask/26.3/elpa/py-import-check-0.2" "/home/jrush/.emacs.d/.cask/26.3/elpa/pyenv-mode-0.1.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/pythonic-0.1.1" "/home/jrush/.emacs.d/.cask/26.3/elpa/request-0.3.2" "/home/jrush/.emacs.d/.cask/26.3/elpa/swiper-0.13.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/ivy-0.13.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/tablist-1.0" "/home/jrush/.emacs.d/.cask/26.3/elpa/treepy-0.1.1" "/home/jrush/.emacs.d/.cask/26.3/elpa/ts-0.2" "/home/jrush/.emacs.d/.cask/26.3/elpa/undo-tree-0.7.4" "/home/jrush/.emacs.d/.cask/26.3/elpa/use-package-2.4" "/home/jrush/.emacs.d/.cask/26.3/elpa/bind-key-2.4" "/home/jrush/.emacs.d/.cask/26.3/elpa/websocket-1.12" "/home/jrush/.emacs.d/.cask/26.3/elpa/with-editor-2.9.3" "/home/jrush/.emacs.d/.cask/26.3/elpa/async-1.9.4" "/home/jrush/.emacs.d/.cask/26.3/elpa/yafolding-0.4.1" "/home/jrush/.emacs.d/.cask/26.3/elpa/yaml-mode-0.0.14" "/home/jrush/.emacs.d/.cask/26.3/elpa/yasnippet-0.14.0" "~/.emacs.d/lisp/" "/etc/emacs" "/usr/local/share/emacs/26.3/site-lisp" "/usr/local/share/emacs/site-lisp" "/usr/share/emacs/site-lisp/dictionaries-common" "/usr/share/emacs/26.3/site-lisp" "/usr/share/emacs/site-lisp" "/usr/share/emacs/26.3/lisp" "/usr/share/emacs/26.3/lisp/vc" "/usr/share/emacs/26.3/lisp/url" "/usr/share/emacs/26.3/lisp/textmodes" "/usr/share/emacs/26.3/lisp/progmodes" "/usr/share/emacs/26.3/lisp/play" "/usr/share/emacs/26.3/lisp/org" "/usr/share/emacs/26.3/lisp/nxml" "/usr/share/emacs/26.3/lisp/net" "/usr/share/emacs/26.3/lisp/mh-e" "/usr/share/emacs/26.3/lisp/mail" "/usr/share/emacs/26.3/lisp/leim" "/usr/share/emacs/26.3/lisp/language" "/usr/share/emacs/26.3/lisp/international" "/usr/share/emacs/26.3/lisp/image" "/usr/share/emacs/26.3/lisp/gnus" "/usr/share/emacs/26.3/lisp/eshell" "/usr/share/emacs/26.3/lisp/erc" "/usr/share/emacs/26.3/lisp/emulation" "/usr/share/emacs/26.3/lisp/emacs-lisp" "/usr/share/emacs/26.3/lisp/cedet" "/usr/share/emacs/26.3/lisp/calendar" "/usr/share/emacs/26.3/lisp/calc" "/usr/share/emacs/26.3/lisp/obsolete")
...
bind-key                  Configured    2020-06-19 Fri 02:11    0.00
general                   Configured    2020-06-19 Fri 02:11    0.02
pallet                    Configured    2020-06-19 Fri 02:11    0.13
hydra                     Configured    2020-06-19 Fri 02:11    0.01
epa-file                  Configured    2020-06-19 Fri 02:11    0.00
org-crypt                 Configured    2020-06-19 Fri 02:11    0.00
ox-jira                   Configured    2020-06-19 Fri 02:11    0.10
ob-browser                Configured    2020-06-19 Fri 02:11    0.00
yasnippet                 Configured    2020-06-19 Fri 02:11    0.04
counsel                   Configured    2020-06-19 Fri 02:11    0.05
grandshell-theme          Configured    2020-06-19 Fri 02:11    0.00
yafolding                 Configured    2020-06-19 Fri 02:11    0.00
highlight-indent-guides   Configured    2020-06-19 Fri 02:11    0.00
rst                       Configured    2020-06-19 Fri 02:11    0.01
org-cliplink              Configured    2020-06-19 Fri 02:11    0.01
org-protocol              Configured    2020-06-19 Fri 02:11    0.00
org-collector             Configured    2020-06-19 Fri 02:11    0.01
origami                   Configured    2020-06-19 Fri 02:12    0.00
org-notmuch               Configured    2020-06-19 Fri 02:11    0.00
atomic-chrome             Configured    2020-06-19 Fri 02:11    0.02
cal-iso                   Configured    2020-06-19 Fri 02:12    0.00

orgnav                    Initialized   2020-06-19 Fri 02:11    0.00
yaml-mode                 Initialized   2020-06-19 Fri 02:11    0.00
python                    Initialized   2020-06-19 Fri 02:11    0.00
org-mime                  Initialized   2020-06-19 Fri 02:11    0.00

org-super-agenda          Declared      2020-06-19 Fri 02:23    0.00

#+BEGIN_SRC emacs-lisp
  (use-package org-super-agenda
    :load-path "~/.emacs.d/lisp/org-super-agenda/"  ;; extend load-path to include my Git checkout of org-super-agenda
    :ensure nil    ;; do NOT install from ELPA but look for it already on my machine
;;;    :pin manual    ;; ignore upstream updates and use my Git checked out version
...
;;;        (message (error-message-string err)))
    ...
    :config ;; code executed AFTER package is loaded
      (message "+++++++++++++ The :config started up after package was loaded.")
...
;;;      (org-agenda-hide-tags-regexp "UNFILED")
  ...
  ("3" "Find :UNFILED: entries" tags  ;; key[1] desc[2] type[3]
    ...
    ( ;; [5] list of settings local to this custom agenda view
      ...
      (org-super-agenda-groups
        '(
           (:name "Collected Links" :tag "LINK")
           (:name "Collected Tasks" :todo t)
           (:name "Collected Notes" :anything t)  ;; place remaining entries under this heading
         )
      )
...
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("R" "Recurring/habits" todo  ;; key[1] desc[2] type[3]
    ...
    ( ; [5] list of settings local to this custom agenda view
      ...
      (org-agenda-remove-tags nil)
;;;      (org-agenda-hide-tags-regexp "BUY")
...
This agenda collects TODO headlines tagged as :BUY: and formats them
with a leading "[ ]" checkbox so I can print them and check them off.

#+NAME: define-agenda-$-FindItemsToPurchase
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("$" "$hopping list(s)" tags-todo  ;; key[1] desc[2] type[3]
    "+BUY"  ;; entry match-expression[4]
    ( ;; [5] list of settings local to this custom agenda view
...
****** Agenda: Find ZeOmega Work Events as a Timeline

This agenda collects event headlines, whether TODO or not, related to a group
the tag "ZEOMEGA".

#+NAME: define-agenda-zT-ZeOmegaTimeline
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("zT" "<T>imeline at ZeOmega" tags ;; key[1] desc[2] type[3]
    "+EVENT+ZEOMEGA-PERSONAL"  ;; entry match-expression[4]
    ( ; [5] list of settings local to this custom agenda view
      (org-agenda-overriding-header "ZeOmega Work Events")
      (org-super-agenda-groups
        '(
;;;          (:auto-ts)
...
;;;          (:name "To Continually Learn            :STUDY:"   :tag ("STUDY" "LINK"))
      ...
      (org-agenda-sorting-strategy '(tsia-down alpha-up))

      (org-agenda-remove-tags nil)
      (org-agenda-hide-tags-regexp "ZEOMEGA\\|EVENT")

      (org-agenda-prefix-format "  ")  ;; remove Category
      (org-super-agenda-unmatched-name "Other Items")
    )
    ("/tmp/ZeOmegaTimeline.pdf")  ;; file(s)-to-export[6]
  )
#+END_SRC

****** Agenda: Find Personal Life Events as a Timeline

This agenda collects event headlines, whether TODO or not, related to a group
the tag "COVID".

#+NAME: define-agenda-pT-PersonalTimeline
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("pT" "<T>imeline for my life" tags ;; key[1] desc[2] type[3]
    "+EVENT+PERSONAL-COVID-ZEOMEGA"  ;; entry match-expression[4]
    ( ; [5] list of settings local to this custom agenda view
      (org-agenda-overriding-header "Personal Life Events")
      (org-super-agenda-groups
        '(
;;;          (:auto-ts)
;;;          (:discard (:tag "ZEOMEGA"))  ;; skip work-related tasks
...
;;;          (:discard (:tag "COMMENT"))  ;; skip commented items in Inbox.org
          ...
          (:name "Birthdays       :BIRTH:"                   :tag "BIRTH")
          (:name "Deathdays       :DEATH:"                   :tag "DEATH")
          (:name "Housing Changes :MOVED:"                   :tag "MOVED")
          (:name "Travels         :TRAVEL:"                  :tag "TRAVEL")
          (:name "Marital Changes"                           :tag ("WEDDING" "DIVORCE" "ENGAGEMENT"))
;;;          (:name "To Explore the World            :TRAVEL:"  :tag "TRAVEL")
;;;          (:name "To Engage with People           :PEOPLE:"  :tag "PEOPLE")
;;;          (:name "To Share Knowledge with Others  :COMPOSE:" :tag ("SHARE" "COMPOSE"))
;;;          (:name "To Continually Learn            :STUDY:"   :tag ("STUDY" "LINK"))
      ...
      (org-agenda-remove-tags nil)
      (org-agenda-hide-tags-regexp "PERSONAL\\|REFILING")

      (org-agenda-prefix-format "  ")  ;; remove Category
      (org-super-agenda-unmatched-name "Other Items")
    )
    ("/tmp/PersonalTimeline.pdf")  ;; file(s)-to-export[6]
  )
#+END_SRC

****** Agenda: Find Covid-19 Events as a Timeline

This agenda collects event headlines, whether TODO or not, related to a group
the tag "COVID".

#+NAME: define-agenda-pC-Covid19Timeline
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("pC" "<T>imeline for COVID-19" tags ;; key[1] desc[2] type[3]
    "+COVID+EVENT"  ;; entry match-expression[4]
    ( ; [5] list of settings local to this custom agenda view
      (org-agenda-overriding-header "Covid-19 Events")
      (org-super-agenda-groups
        '(
;;;           (:auto-ts)
;;;          (:discard (:tag "ZEOMEGA"))  ;; skip work-related tasks
...
;;;          (:name "To Continually Learn            :STUDY:"   :tag ("STUDY" "LINK"))
      ...
      (org-agenda-remove-tags nil)
      (org-agenda-hide-tags-regexp "COVID\\|EVENT")

      (org-agenda-prefix-format "  ")  ;; remove Category
      (org-super-agenda-unmatched-name "Other Items")
    )
    ("/tmp/Covid-19Events.pdf")  ;; file(s)-to-export[6]
  )
...
#+NAME: define-agenda-pa-PersonalScheduledTasksNEWWAY
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("pa" "<a>genda (personal) for next two weeks" ;; key[1] desc[2]

    ( ; type[3] a custom function instead of 'agenda'/'org-agenda-list'
      (org-ql-block
        '(and
           (or
             (deadline 14)
         ...
         (
           (org-ql-block-header "PERSONAL AGENDA VIA ORG-QL")
         )
      )
      (agenda)
    )
    ...
    ( ; [5] list of settings local to this custom agenda view
      ...
      (org-agenda-remove-tags nil)
      (org-agenda-hide-tags-regexp "FINANCE\\|HABIT\\|RECUR")
...
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("pa" "<a>genda (personal) for next two weeks" agenda  ;; key[1] desc[2] type[3]
...
;;;      (:name "To Have a Fantastic Career           :ZEOMEGA:" :tag "ZEOMEGA")
      ...
      (:name "To Engage with People           :PEOPLE:"  :tag "PEOPLE")
      (:name "To Share Knowledge with Others  :COMPOSE:" :tag ("SHARE" "COMPOSE"))
      (:name "To Continually Learn            :STUDY:"   :tag "TO_STUDY")
      (:name "To Experience Life's Magic      :EVENT:"   :tag "EVENT")
      (:name "To Explore the World            :TRAVEL:"  :tag "TRAVEL")
...
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("za" "<a>genda (ZeOmega) for next two weeks" agenda  ;; key[1] desc[2] type[3]
    ...
    ( ; [5] list of settings local to this custom agenda view
      ...
      (org-agenda-remove-tags nil)
      (org-agenda-hide-tags-regexp "ZEOMEGA\\|REFILING")
...
;;; create a section for DONE tasks in ZeOmega, directing me to archive them.
      ...
      (:name "Completed Tasks"                             :todo "DONE")
    )
  )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("pb" "<b>acklog (personal) of unscheduled tasks" todo  ;; key[1] desc[2] type[3]
    nil  ;; entry match-expression[4]
    ( ; [5] list of settings local to this custom agenda view
      ...
      (org-agenda-remove-tags nil)
;;;      (org-agenda-hide-tags-regexp "DIRECTION\\|PERSONAL")
...
#+BEGIN_SRC emacs-lisp
  (setq agendagroups/personal-backlog-tasks
    '(
       ...
       (:name "Unplanned Shopping             :BUY:"      :tag "BUY")
...
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("zb" "<b>acklog (ZeOmega) of unscheduled tasks" todo  ;; key[1] desc[2] type[3]
    nil  ;; entry match-expression[4]
    ( ; [5] list of settings local to this custom agenda view
...
****** Agenda: List Personal Life Directions

#+NAME: define-agenda-pD-PersonalDirections
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("pD" "<D>irections in my life" tags  ;; key[1] desc[2] type[3]
    "+TAGS={:DIRECTION:}+PERSONAL"  ;; entry match-expression[4]
    ( ;; [5] list of settings local to this custom agenda view
      (org-agenda-overriding-header "Life Directions")

      (org-agenda-prefix-format "  ")  ;; remove Category
      (org-agenda-remove-tags nil)
      (org-agenda-hide-tags-regexp "DIRECTION\\|PERSONAL")
    )
    ("/tmp/DirectionsPersonal.pdf")  ;; file(s)-to-export[6]
  )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("zD" "<D>irections in technology at ZeOmega" tags  ;; key[1] desc[2] type[3]
    ...
    ( ;; [5] list of settings local to this custom agenda view
      ...
      (org-agenda-prefix-format "  ")  ;; remove Category
      (org-agenda-remove-tags nil)
      (org-agenda-hide-tags-regexp "DIRECTION\\|ZEOMEGA")
    )
    ("/tmp/DirectionsTechnology.pdf")  ;; file(s)-to-export[6]
  )
#+END_SRC

****** Agenda: List Personal Life Documents

#+NAME: define-agenda-pd-PersonalDocuments
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("pd" "<d>ocuments in my life"     ;; key[1] desc[2]
    (                                ;; type[3] => a set of agendas
      (tags  ;; type[3a]
        "+TAGS={:DOCUMENT:}-ZEOMEGA"  ;; entry match-expression[4]
        ( ;; [5] list of settings local to this custom agenda view
          (org-agenda-overriding-header "Useful Personal Documents")
;;          (org-agenda-prefix-format "  ")  ;; remove Category
          (org-agenda-remove-tags nil)
          (org-agenda-hide-tags-regexp "DOCUMENT\\|PERSONAL\\|REFILING")
        )
        ("/tmp/PersonalDocuments.pdf")  ;; file(s)-to-export[6]
      )
    )
  )
#+END_SRC

****** Agenda: List Personal Life Initiatives

#+NAME: define-agenda-pI-PersonalInitiatives
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("pI" "<I>nitiatives in my life"  ;; key[1] desc[2]
    (                                ;; type[3] => a set of agendas
      (tags  ;; type[3a]
        "+TAGS={:INITIATIVE:}-ZEOMEGA"  ;; entry match-expression[4]
        ( ;; [5] list of settings local to this custom agenda view
          (org-agenda-overriding-header "\nACTIVE Personal Initiatives")
          (org-super-agenda-groups agendagroups/personal-scheduled-initiatives)

          (org-agenda-sorting-strategy '(todo-state-up priority-down deadline-up))

          (org-agenda-remove-tags nil)
          (org-agenda-hide-tags-regexp "INITIATIVE\\|PERSONAL\\|REFILING\\|DIRECTION")
        )
      )
      (tags  ;; type[3a]
        "+TAGS={:INITIATIVE:}-ZEOMEGA"  ;; entry match-expression[4]
        ( ;; [5] list of settings local to this custom agenda view
          (org-agenda-overriding-header "\nPLANNED Personal Initiatives")
          (org-super-agenda-groups agendagroups/personal-initiatives)
        ...
        ("/tmp/InitiativesPersonal.pdf")  ;; file(s)-to-export[6]
      )
    )
  )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (setq agendagroups/personal-scheduled-initiatives
    '(
       (:name "Initiatives Started"
         :scheduled t
         :deadline t

         :order 0
       )
       (:discard (:anything t)) ;; discard all unscheduled initiatives
    )
  )
#+END_SRC

#+BEGIN_SRC emacs-lisp
  (setq agendagroups/personal-initiatives
    '(
       (:order-multi (99 (:auto-multiproperty "DIRECTION")))
...
****** Agenda: List Technology Documents for ZeOmega

#+NAME: define-agenda-zd-TechDocuments
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("zd" "<d>ocuments in technology at ZeOmega"  ;; key[1] desc[2]
    (                               ;; type[3] => a set of agendas
      (tags  ;; type[3a]
        "+TAGS={:DOCUMENT:}+ZEOMEGA"  ;; entry match-expression[4]
        ( ;; [5] list of settings local to this custom agenda view
...
;;          (org-agenda-prefix-format "  ")  ;; remove Category
          ...
          (org-agenda-remove-tags nil)
          (org-agenda-hide-tags-regexp "DOCUMENT\\|ZEOMEGA\\|REFILING")
        )
        ("/tmp/TechnologyDocuments.pdf")  ;; file(s)-to-export[6]
      )
    )
  )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("zI" "<I>nitiatives in technology at ZeOmega"  ;; key[1] desc[2]
    (                               ;; type[3] => a set of agendas
      (tags  ;; type[3a]
        "+TAGS={:INITIATIVE:}+ZEOMEGA"  ;; entry match-expression[4]
        ( ;; [5] list of settings local to this custom agenda view
          (org-agenda-overriding-header "\nACTIVE Technology Initiatives")
          (org-super-agenda-groups agendagroups/zeomega-scheduled-initiatives)

          (org-agenda-remove-tags nil)
          (org-agenda-hide-tags-regexp "INITIATIVE\\|ZEOMEGA\\|REFILING")
        )
      )
      (tags  ;; type[3a]
        "+TAGS={:INITIATIVE:}+ZEOMEGA"  ;; entry match-expression[4]
        ...
        ("/tmp/InitiativesTechnology.pdf")  ;; file(s)-to-export[6]
      )
    )
  )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (setq agendagroups/zeomega-scheduled-initiatives
    '(
       (:name "Initiatives Started"
         :scheduled t
         :deadline t
...
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("zC" "<C>lients of ZeOmega" tags  ;; key[1] desc[2] type[3]
    "+TAGS={:CLIENT:}+ZEOMEGA-MEETING"  ;; entry match-expression[4]
    ( ;; [5] list of settings local to this custom agenda view
      ...
      (org-agenda-remove-tags nil)
      (org-agenda-hide-tags-regexp "CLIENT\\|ZEOMEGA")
    )
    ("/tmp/ZeOmegaClients.pdf")  ;; file(s)-to-export[6]
  )
#+END_SRC

****** Agenda: Find My ZeOmega Meetings

- MEETINGS -or- MEETING?
- should datestamp be at beginning or end?
- can I refine my search to client meetings?

#+NAME: define-agenda-zM-ZeOmegaMeetings
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("zM" "<M>eetings at ZeOmega" tags  ;; key[1] desc[2] type[3]
    ...
    ( ;; [5] list of settings local to this custom agenda view
      ...
      (org-super-agenda-groups '(
      (:name "One-on-One Meetings"      :regexp "1:1")
      (:name "Recurring Meetings"       :tag "RECUR")
      (:name "Client/Partner Meetings"  :tag "CLIENTMTG")

        ;; After the last group, the agenda will display items that didn't
        ;; match any of these groups, with the default order position of 99
      ))
      (org-super-agenda-unmatched-name "Other Meetings")

      (org-agenda-prefix-format "  ")  ;; remove Category
      (org-agenda-remove-tags nil)
      (org-agenda-hide-tags-regexp "MEETING\\|REFILING\\|ZEOMEGA")
    )
...
#+BEGIN_SRC emacs-lisp :exports code :tangle no
  ("s" "<s>tudy these things" tags  ;; key[1] desc[2] type[3]
    "+TAGS={:TO_STUDY:}"  ;; entry match-expression[4]
    ( ;; [5] list of settings local to this custom agenda view
      ...
      (org-agenda-prefix-format "  ")  ;; remove Category
      (org-agenda-remove-tags nil)
      (org-agenda-hide-tags-regexp "TO_STUDY\\|ZEOMEGA\\|REFILING")
    )
...
#+BEGIN_SRC emacs-lisp
  (setq agendagroups/things-to-study
    '(
      (:name "Financial Learning        :FINANCE:"    :tag "FINANCE")
      ...
      (:name "Emacs Editor              :EMACS:"      :tag "EMACS")
      (:name "Python Programming        :PYTHON:"     :tag "PYTHON")
      (:name "Mathematics               :MATH:"       :tag "MATH")
      (:name "Linux                     :LINUX:"      :tag "LINUX")
      (:name "AI/ML                     :AIML:"       :tag "AIML")
...
- origami-mode (bind your choice of keys to origami-mode-map)
  - try this on Python source
  - try the built-in hs-mode on Python source
- global-origami-mode
...
#+BEGIN_SRC emacs-lisp
  (use-package org-mime
    ...
    :hook
      ;; inside Message buffers, enable a subset of Org-Mode behavior
      (message-mode . turn-on-orgstruct++)
      (message-mode . turn-on-orgtbl)
      ;; inside Message buffers, assign a key to convert the Org-Mode formatted message body into MIME-encoded HTML
      (message-mode . (lambda ()
...
** Publishing Org Files into Other Formats, Carrying Along Graphics and Other Files
...
All projects are centrally defined in the ~org-publish-project-alist~, with
paths to the Org file source and paths to where to write the resulting
outputs.  Projects can be arranged into a graph by using the :components
property, where publishing a senior-level project causes all the related ones
to be published as well.

A publish operation is initiated by the key sequence:

  : M-x org-publish-project RET <your project name> RET

#+BEGIN_SRC elisp
  (org-publish-project "techdocs-remote" t)
#+END_SRC
...
#+BEGIN_SRC elisp
  ...
  (setq org-publish-project-alist
     '(
         ...
         ("techdocs-papers-local"
            :base-directory "~/Dropbox/Documents/techdocs/"
            :publishing-directory "~/Dropbox/Documents/sites/techdocs/"

            :base-extension "org"
            :exclude ".*\\.org"
            :include (
               "index.org"
               "rulesengine-speedup.org"
               "clustercomputing-hadoop.org"
               "officetools.org"
               "multicloud.org"
               "howto-dockerfiles.org"
               "whykubernetes.org"
               "devguide.org"
               "opsguide.org"
               "careintel.org"
            ...
            :auto-preamble t
            :auto-sitemap t
            :sitemap-title "Sitemap of PTE Whitepapers"
         ...
         ("techdocs-statics-local"
            :base-directory "~/Dropbox/Documents/techdocs/"
            :publishing-directory "~/Dropbox/Documents/sites/techdocs/"
            ;; :publishing-directory "/ssh:jrush@techdocs.zeomega.org:~/html/techdocs/"
         ...
         ;; Publish Component
         ("techdocs-local"
            :components ("techdocs-papers-local" "techdocs-statics-local")
         )

         ;; Publish as HTML all the Org-mode files into Publishing Directory
         ("techdocs-papers-remote"
            :base-directory "~/Dropbox/Documents/techdocs/"
            ;;:publishing-directory "~/Dropbox/Documents/sites/techdocs/"
            :publishing-directory "/ssh:techdocs:~/public_html/"
         ...
         ;; Publish Component
         ("techdocs-remote"
            :components ("techdocs-papers-remote" "techdocs-statics-remote")
         )
...
:END:
   ...
   source https://git.zeomega.com/jiva-platform/techdocs
     - index.org
     - remember.org
     - css/
       - stylesheet.css
    ...
    (setq
      txt
        (cond
          ...
          ( ; clause 2
            name     ;; if element has a name, use it as anchor
          )
          ( ; clause 3
            (org-region-active-p)  ;; if region is active, use it as anchor
...
** Writing My Own New Major Mode
- [[https://www.emacswiki.org/emacs/ModeTutorial][EmacsWiki: Mode Tutorial]]
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; allow the user to run their own code when mode is run
  (defvar pgm-mode-hook nil)

  ;; create a default keymap and insert any key definitions we need
  (defvar pgm-mode-map
    (let
      (
        ;; if very few key entries, consider using 'make-sparse-keymap'
        (map (make-keymap))
      )
      (define-key map "\C-j" 'newline-and-indent)
      ;; key ?? to show buffer containing generated code
      ;; TAB to fold/unfold hierarchy sections
      ;; key ?? to parse existing source into pdecisions
      map
    )
  ...
  (defun pgm-mode ()
    "Major mode for defining abstract programs"
    (interactive)
    (kill-all-local-variables)
    ;; (set-syntax-table wpdl-mode-syntax-table)
    (use-local-map pgm-mode-map)

    ;; Specify the font-lock (syntax highlighting) default keywords
    ;; (set
    ;;    (make-local-variable 'font-lock-defaults)
    ;;    '(wpdl-font-lock-keywords)
    ;; )

    ;; Register our line indentation function.
    ;;  (set
    ;;    (make-local-variable 'indent-line-function)
    ;;    'wpdl-indent-line
    ;;  )

    (setq major-mode 'pgm-mode)
    (setq mode-name "PGM")
    (run-hooks 'pgm-mode-hook)
  )
...
** Adding an Org-Bable Executor for Source Block Types 'yaml' and 'text'

When using source blocks representing configuration files (yaml and text),
I need an org-babel-execute function for each that:

 1) just returns the content if no :file header-arg is present
 2) if :file header-arg *is* present, write content to file and return the filename

#+BEGIN_SRC emacs-lisp
  (defun org-babel-execute:yaml (body params)
    "Return a block of YAML code with Babel.
...
;;        (return-val
;;          (when (and (eq result-type 'value) (not session))
;;            (cdr (assq :return params)))
;;        )

;;        (preamble
;;          (cdr (assq :preamble params))
;;        )
...
;;      )
  ...
  (defun org-babel-execute:text (body params)
    "Return a block of TEXT code with Babel.
This function is called by `org-babel-execute-src-block'."
    (let*
      (
;;        (org-babel-python-command
...
The following is faster than the default of 'scp'.
...
The below is how to add support for "docker exec" to Tramp.  First, install
the docker-tramp package.

tramp version: ???
docker-tramp version: ???
  ...
  (defadvice tramp-completion-handle-file-name-all-completions
    ...
    (if (equal (ad-get-arg 1) "/docker:")
      (let*
        (
          (dockernames-raw
            (shell-command-to-string "docker ps | awk '$NF != \"NAMES\" { print $NF \":\" }'")
          )

          (dockernames
            (cl-remove-if-not #'(lambda (dockerline) (string-match ":$" dockerline))
...
(requires an old version of dash)
...
** Test1
blah lbah This is a test.  And so is this.  blah
Test
Test
** Test2
blah lbah This is a test.  And so is this.  blah
...
* Anki Editor -- Maintain Anki Knowledgebase in Org-Mode
