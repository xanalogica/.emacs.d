...
#+BEGIN_SRC emacs-lisp
  (setq groups/zeomega-scheduled-tasks  ;; presentation definition using org-super-agenda
    '(
      ...
      (:name "To Not Worry about Money" :and (:tag "FINANCE" :tag "ZEOMEGA"))
      (:name "To Take Care of Life's Little Chores" :and (:tag "CHORE" :tag "ZEOMEGA"))
      (:name "To Experience Life's Magic" :and (:tag "EVENT" "ZEOMEGA"))
      (:name "To Explore the World" :and (:tag "TRAVEL" :tag "ZEOMEGA"))
      (:name "To Stay in Touch with Others" :and (:tag "PEOPLE" :tag "ZEOMEGA"))
      (:name "To Share My Knowledge with Others" :and (:tag "WRITING" :tag "ZEOMEGA"))
      (:name "To Continually Learn New Things" :and (:tag "STUDY" :tag "ZEOMEGA"))
      (:name "To Have a Fantastic Career" :tag "ZEOMEGA")
      ;; After the last group, the agenda will display items that didn't
      ;; match any of these groups, with the default order position of 99
    )
