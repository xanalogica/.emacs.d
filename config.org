...
The :unread: tag is less reliable as my mobile apps for reading email 
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq notmuch-saved-searches '(
    (:name "Directs"
       :query "tag:inbox and tag:directSam"
       :key   "D"
       :count-query "tag:inbox and tag:directSam and tag:unread"
       :sort-order newest-first
       :search-type 'tree)
    (:name "Flagged"
       :query "tag:inbox and tag:flagged"
       :key   "F"
       :count-query "tag:inbox and tag:flagged and tag:unread"
       :sort-order newest-first
       :search-type 'tree)
    (:name "Drafts"
       :query "tag:draft"
    ...
    (:name "tagTraining"
       ...
       :key   "tT"
       :count-query "tag:inbox and tag:training and tag:unread"
       :sort-order newest-first
       :search-type 'tree)
  ))
...
;;Value: ((:name "inbox" :query "tag:inbox" :key "i")
;; (:name "unread" :query "tag:unread" :key "u")
;; (:name "sent" :query "tag:sent" :key "t")
;; (:name "drafts" :query "tag:draft" :key "d")
;; (:name "all mail" :query "*" :key "a")
;; (:name "SamMails" :query "from:sam")
;; (:name "ZeAllMail" :query "tag:zeomega" :key "ZA")
;; (:name "XanaMail" :query "tag:xanalogica" :key "X")
;; (:name "ZeInbox" :query "tag:zeomega and tag:inbox" :key "ZI"))
