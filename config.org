...
This agenda view represents "work things I have scheduled to get done, either
because they have a DEADLINE, or because they are tagged :HOT: meaning I need
to work on them *today*.  Those that are scheduled, I limit to the next
14-days.
...
;;;      (:name "Maintain Physical/Mental Health  :HEALTH:" :tag "HEALTH")
      ...
      (:name "To Engage with People                :PEOPLE:"    :tag "PEOPLE")
      (:name "To Share My Knowledge                :WRITING:"   :tag "WRITING")
      (:name "To Continually Learn                 :STUDY:"     :tag "STUDY")
      ...
      (:name "Tasks Scheduled for Today            :HOT:"     :tag "HOT")
      (:name "Maintain Physical and Mental Health  :HEALTH:"  :tag "HEALTH")
      (:name "To Not Worry about Money             :FINANCE:" :tag "FINANCE")
;;;      (:name "To Have a Fantastic Career           :ZEOMEGA:" :tag "ZEOMEGA")
      (:name "To Take Care of Life's Little Chores :CHORE:"   :tag "CHORE")
      (:name "To Experience Life's Magic           :EVENT:"   :tag "EVENT")
      (:name "To Explore the World                 :TRAVEL:"  :tag "TRAVEL")
      (:name "To Stay in Touch with Others         :PEOPLE:"  :tag "PEOPLE")
