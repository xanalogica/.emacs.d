...
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'org-verbatim nil :foreground "LightGrey" :box "Orange" :inverse-video t :inherit shadow)
  (set-face-attribute 'org-list-dt nil :foreground "LightGrey" :box "Orange" :inverse-video t)
  (set-face-attribute 'org-code nil :foreground "LightGrey" :box "Green" :inverse-video t :inherit shadow)
;;;  (set-face-attribute 'org-list-dt :foreground "LightGrey" :box "Red" :inverse-video t)
;;  (set-face-attribute 'org-code nil '(:foreground "Blue"))
