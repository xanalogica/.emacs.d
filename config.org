...
There seems to be a bug in the Orgzly Android app, in that each
time a new entry is created, it adds a SCHEDULED date of the day
it was created.  This messes up my agenda views, making me think that
every such entry has been scheduled for me to work on it.
