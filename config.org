...
configuration symbol =:diminish <SYMBOL>= in your ~use-package~ invocation.
This symbol empowers you to remove or change minor mode strings in your
mode-line.

can be used to remove or change minor mode
strings in your mode-line, by using thein your
