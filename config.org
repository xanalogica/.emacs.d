...
- I initially started with passive tag words like TOSTUDY or THINGSTOSTUDY
  but since have switched to imperative tag words to encourage my mind to actually do them
  and avoid passive tags like TOSTUDY or THINGSTOSTUDY.
...
- STUDY
  ...
  Technology.  I do something apply a priority tag to them but generally don't
  further subdivide or organize them.

  On my Android, I have the Orgzly app installed and watching my Dropbox
  collection of .org files.  And I have defined a named search in Orgzly
  titled "Things to Study" with the query "tn.study o.priority" so I can at
  any time pull up and study something when I have spare time.
