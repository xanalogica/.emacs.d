...
#+BEGIN_SRC emacs-lisp
  ...
  (setq notmuch-saved-searches '(
    ...
    (:name "Unknowns"   ; EMAIL FROM PEOPLE I DON'T KNOW
       :query "not tag:known and not tag:spam and not tag:sent"
       :key   "U"
       :count-query "not tag:known and not tag:spam and not tag:sent"
