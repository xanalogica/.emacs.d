...
;; :foreground "Orange" :box "White" :inverse-video t
...
****** Segmented View for "Links Needing Refiling"
...
#+BEGIN_SRC emacs-lisp
  (setq groups/backlog-tasks  ;; presentation definition using org-super-agenda
    '(
       ...
       (:name "Unschedule SysAdmin Tasks" :tag "SYSADMIN")
       (:name "Unscheduled Chores" :tag "CHORE")

       (:name "Unscheduled ZeOmega Work" :tag "ZEOMEGA")

       (:name "Unscheduled Financials" :tag "FINANCE")
       (:name "Unscheduled Health Matters" :tag "HEALTH")

       (:name "Unscheduled Christmas Planning" :tag "CHRISTMAS")
       ...
       (:name "Unplanned People Socialization" :tag "PEOPLE")
...
#+BEGIN_SRC emacs-lisp
  (setq groups/shopping-lists  ;; presentation definition using org-super-agenda
    '(
       ...
       ;; TBD: a Technology section, for going to Fry's Electronics
    ...
    '(
       ("P" "Agenda for Current Period" agenda  ;; key[1] desc[2] type[3]
         ...
         ( ; [5] list of settings local to this custom agenda view
           ...
           (org-agenda-overriding-header "Agenda for a Time Period")
         )
       ...
       ("B" "Backlog of Unscheduled Tasks" todo  ;; key[1] desc[2] type[3]
         ...
         ( ; [5] list of settings local to this custom agenda view
           ...
           (org-agenda-compact-blocks t)  ;; experimental
       ...
       ("F" "Captured Links Needing Filing" tags  ;; key[1] desc[2] type[3]
         "REFILING"  ;; entry match-expression[4]
         ( ;; [5] list of settings local to this custom agenda view
           (org-super-agenda-groups groups/links-needing-refiling)
           (org-agenda-remove-tags nil)
           (org-agenda-with-colors t)
           (org-agenda-overriding-header "Captured Info Needing Filing")
         )
         ("/tmp/CapturedNewLinks.pdf")  ;; file(s)-to-export[6]
       )

       ("S" "Shopping List(s)" tags-todo  ;; key[1] desc[2] type[3]
