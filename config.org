...
#+BEGIN_SRC emacs-lisp
("bp" "a Bloodpressure measurement" table-line
 (file+headline "~/Dropbox/Documents/Org-Mode/Health.org" "Jeff's Blood Pressure History")
 "| %u | %^{High} | %^{Low} | %^{Pulse} |" :prepend :unnarrowed :kill-buffer)
#+END_SRC
...
#+RESULTS:
#+BEGIN_SRC emacs-lisp
("bb" "a Bloodpressure measurement" table-line
 (file+headline "~/Dropbox/Documents/Org-Mode/Health.org" "Jeff's Blood Pressure History")
 "| %u | %^{High} | %^{Low} | %^{Pulse} |" :prepend :unnarrowed :kill-buffer)
#+END_SRC
...
#+RESULTS:
| keyseq | a Bloodpressure measurement | table-line | (file+headline ~/Dropbox/Documents/Org-Mode/Health.org Jeff's Blood Pressure History) |   | %u | %^{High} | %^{Low} | %^{Pulse} |   | :prepend | :unnarrowed | :kill-buffer |
| z      | ZeOmega Capture Templates   |            |                                                                                       |   |    |          |         |           |   |          |             |              |
