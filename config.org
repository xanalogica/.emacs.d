...
place.  It uses the following replaceable parameters.
  ...
  - %^{Score}    :: prompt "High" and insert a value for high pressure
  - %^{Meaning}  :: prompt "Low" and insert a value for low pressure
  - %^{Events}   :: prompt "Pulse" and insert a value for pulse rate
