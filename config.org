...
The github:[[https://github.com/myrjola/diminish.el][dimish]] Elisp package can be used to remove or change minor mode strings
in your mode-line, by using the =:diminish <SYMBOL>= in your ~use-package~
invocation.
