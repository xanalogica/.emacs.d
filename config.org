...
**** maintain physical health, to stay in the game
- to achieve a black belt
- to achieve certain martial arts gymnastics
**** increase mental effectiveness, continually
- to have a personal assistant
  - make phone calls
  - do laundry
  - do housecleaning
  - do car repairs/maintenance
**** share my experiences with others, so if I fall others can continue, to help others grow
- to develop a platform for blogging/teaching online
- build a supernormal social network of friends
**** strengthen finances, to support me as needed; the known + the unknown expenses
- to pay off my balances
  - AmEx		@ 15.24%
  - Chase 5979	@ 15.24%
  - Capital One	@ 13.90%
  - Chase 8090	@ 12.24%
  - HSBC		@ 5.99%
- to build a stream of incoming that requires little of my time
**** efficiently learn new things, incorporating them into me




                (:name "Section: Maintain Physical and Mental Health" :tag "HEALTH" :face (:underline t)  :time-grid t)
                (:name "Section: Finance"        :tag "FINANCE" :transformer (--> it (upcase it)))
