...
to work on them *today*.  Those that are scheduled, I limit to the next
14-days.
...
either because they have a DEADLINE, or because they have a SCHEDULED start
date today or in the past.  Those that are scheduled, I limit to the next
14-days.
