...
Note that this applies to any headline tagged :UNFILED: and that it does not
have to be a TODO headline.

#+NAME: define-agenda-FindUnfiledEntries
#+BEGIN_SRC emacs-lisp :exports code
...
#+NAME: define-agenda-FindRecurringTasks
#+BEGIN_SRC emacs-lisp :exports code
...
#+BEGIN_SRC emacs-lisp :exports code :noweb yes
  ...
  (setq org-agenda-custom-commands
    '(
       <<declare-agenda-FindUnfiledEntries>>
       <<declare-agenda-FindRecurringTasks>>
