...
**** efficiently learn new things, incorporating them into me
                ...
                (:name "Maintain Physical and Mental Health" :tag "HEALTH" :face (:underline t)  :time-grid t)
                (:name "Strengthen Finances to Support Me as Needed" :tag "FINANCE" :transformer (--> it (upcase it)))
                ...
                (:name "Share My Experiences with Others"        :tag "WRITING")
