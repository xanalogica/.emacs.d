...
symbols is in [[https://github.com/jwiegley/use-package/blob/master/use-package-bind-key.el]]
...
The ~general~ package is primarily for making key definition more clear and
concise.
...
#+BEGIN_SRC emacs-lisp
  (use-package origami
    :ensure nil
    :load-path "~/.emacs.d/lisp/origami.el/" ;; use my Git checkout
