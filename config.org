...
Show all matches across all files in the current directory.

NEED: Show all matching headlines in THIS file.
...
Show all headlines for all agenda files.

NEED: Sow all matching headlines in THIS file.
