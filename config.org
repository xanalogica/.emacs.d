...
(("l" "Captured Links" entry
 ...
 ("t" "Captured Links" entry
  (file+headline "~/Dropbox/Documents/index.org" "Captured Tasks")
  "*** %(org-cliplink-capture) %^G\n:PROPERTIES:\n:CREATED: %U\n:END:\ni:%i\nx:%x\na:%a\n%?" :prepend nil :kill-buffer t :empty-lines-before 0 :empty-lines-after 1)
 ("b" "Personal Bookmark" entry
  (file+headline "~/Dropbox/Documents/index.org" "Unclassified Bookmarks")
  "** Bookmark: %(org-cliplink-capture) %^G\n:PROPERTIES:\n:CREATED: %U\n:END:\n%i\n%?" :prepend t :kill-buffer t :empty-lines-before 0 :empty-lines-after 1)
 ...
 ("zf" "Hadoop/Financial" entry
  (file+olp "~/Dropbox/Documents/ZeOmega.org" "Hadoop: Financial Dashboard" "Meetings")
  "** Meeting: %U Hadoop/Financial\n:LOGBOOK:\n:END:\n%i%?\n" :prepend t :kill-buffer t :empty-lines 1 :clock-in t :clock-resume t :clock-keep nil)
 ("zs" "Hadoop/Sentinel Engine" entry
  (file+olp "~/Dropbox/Documents/ZeOmega.org" "Hadoop: Sentinel Engine" "Meetings")
  "** Meeting: %U Hadoop/Sentinel\n:LOGBOOK:\n:END:\n%i%?\n" :prepend t :kill-buffer t :empty-lines 1 :clock-in t :clock-resume t :clock-keep nil)
 ("zb" "ZeOmega Bookmark" entry
  (file+headline "~/Dropbox/Documents/ZeOmega.org" "Unclassified Bookmarks")
  "** Bookmark: %(org-cliplink-capture) %^G\n:PROPERTIES:\n:CREATED: %U\n:END:\n%i\n%?" :prepend t :kill-buffer t :empty-lines-before 0 :empty-lines-after 1))
#+END_SRC
